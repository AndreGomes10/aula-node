...
app.get('/users/:id', (req, res) => {  // pegar id por url
    const id = req.params.id

    // leitura da tabela users, resgatar um usuario do banco
    console.log(`Estamos buscando pelo usuário: ${id}`)

    res.sendFile(`${basePath}/users.html`)  // ele envia a resposta de um arquivo, vamos unir a variavel de basePath com a index.html
})
